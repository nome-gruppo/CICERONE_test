...
define('ERROR_MESSAGE_TUR', 'Errore di connessione');
...
class Turista extends User
{
    ...
    public function searchActivity($citta, $lingua, $data_inizio, $data_fine){
      ...
      $result = mysqli_query($link, $query)or die(ERROR_MESSAGE_TUR);
      mysqli_close($link);
      return $result;
    }
