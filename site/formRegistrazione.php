...
<body>
	...
	<ul class="nav nav-pills">
		<li role="presentation" class="active"><a
			href="formRegistrazione.html">Cicerone</a></li>
		<li role="presentation"><a href="formRegistrazioneTurista.html">Turista</a></li>
	</ul>

	<h1></h1>
	<form action="registrazioneCicerone.php" method="post">
		...
		<div class="form-group">
			<div class="text-center">
				<button type="submit" class="btn btn-primary" name="invia_dati">REGISTRATI</button>
			</div>
		</div>
	</form>
